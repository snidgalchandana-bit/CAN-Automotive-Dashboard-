...
void init_can(void);
unsigned char can_receive(unsigned int *len,unsigned char *msg_id,unsigned char res_data[]);
...
void config(void) {
    ...
    init_clcd();
    clcd_print("G SP TEMP RPM  I",(0x80 + (0)));
     init_can();
}
...
void main(void) {
    ...
    while(1) {
        ...
        switch(msg_id) {
            case 0x10: clcd_putch(gear_rx[0], (0xC0 + (0)));
                              break;
            case 0x20: clcd_putch(speed_rx[0], (0xC0 + (2)));
                               clcd_putch(speed_rx[1], (0xC0 + (3)));
                               break;
            case 0x30: clcd_putch(temp_rx[0], (0xC0 + (5)));
                              clcd_putch(temp_rx[1], (0xC0 + (6)));
                              clcd_putch(temp_rx[2], (0xC0 + (7)));
                              clcd_putch(temp_rx[3], (0xC0 + (8)));
                              break;
            case 0x40: clcd_putch(rpm_rx[0],(0xC0 + (10)));
                             clcd_putch(rpm_rx[1],(0xC0 + (11)));
                             clcd_putch(rpm_rx[2],(0xC0 + (12)));
                             clcd_putch(rpm_rx[3],(0xC0 + (13)));
                              break;
            case 0x50: clcd_putch(ind_rx[0],(0xC0 + (15)));
                              break;
        }
    }
    return;
